    ...
    <div className="page-shell py-8 sm:py-10 fade-in-section">
      ...
      {isAdmin && analytics && (
        <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-3">
          <div className="stat-card flex items-center justify-between p-6">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-muted">Total accounts</p>
              <p className="mt-2 text-3xl font-semibold text-ink">{analytics.totalUsers}</p>
            </div>
            <Users className="h-10 w-10 text-primary" />
          </div>
          <div className="stat-card flex items-center justify-between p-6">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-muted">Events created</p>
              <p className="mt-2 text-3xl font-semibold text-ink">{analytics.totalEvents}</p>
            </div>
            <Calendar className="h-10 w-10 text-success" />
          </div>
          <div className="stat-card flex items-center justify-between p-6">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-muted">Total bookings</p>
              <p className="mt-2 text-3xl font-semibold text-ink">{analytics.totalRegistrations}</p>
            </div>
